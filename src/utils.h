...
{
    static constexpr const int width                    = 400;
    static constexpr const int height                   = 150;
    static constexpr const int button_outline_thickness = -5;
    static constexpr const int button_text_size         = 50;
}
...
{
    static const QColor button_color        = QColor(58, 50, 119);
    static const QColor button_line_color   = QColor(Qt::black);
    static const QColor background_color    = QColor(103,  113, 169);
